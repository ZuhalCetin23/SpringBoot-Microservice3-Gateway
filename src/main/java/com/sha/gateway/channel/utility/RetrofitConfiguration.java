...
import com.sha.gateway.model.service.ProductService;
...
public class RetrofitConfiguration
{
    ...
    @Bean
    public ProductServicesCallable createProductServiceRequest(Retrofit.Builder secureKeyBuilder,
                                                               @Value("${product.service.url}") String baseUrl)
    {
        return secureKeyBuilder.baseUrl(baseUrl).build().create(ProductServicesCallable.class);
    }
